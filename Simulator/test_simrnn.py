...
from Simulator.simrnn_main import cell_config
from Simulator.simrnn_main import FLAGS
    ...
    with tf.Session() as sess:
        ...
        for test_batch_X, test_batch_y in boiler_dataset.generate_one_epoch(test_X, test_y, FLAGS.batch_size):
            test_data_feed = {
                ...
                rnn_model.inputs: test_batch_X,
                rnn_model.targets: test_batch_y,
            }
            # re-scale predicted labels
            batch_preds = sess.run(rnn_model.pred, test_data_feed)
